...
execute if score @s w-count matches 0 run item replace entity @a container.35 with minecraft:arrow{display:{Name:'[{"text":"Ok","italic":false,"color":"red","bold":true}]'},w-default-item:1b}

execute store result score @s w-count run clear @s minecraft:ender_pearl 0
execute if score @s w-count matches 16.. run clear @s minecraft:ender_pearl 1

execute store result score @s w-count run clear @s minecraft:ender_eye{w-firework:1b,w-enchanted:0b} 0
execute if score @s w-count matches 7.. run clear @s minecraft:ender_eye{w-firework:1b,w-enchanted:0b} 1

execute store result score @s w-count run clear @s minecraft:ender_eye{w-firework:1b,w-enchanted:1b} 0
execute if score @s w-count matches 5.. run clear @s minecraft:ender_eye{w-firework:1b,w-enchanted:1b} 1
